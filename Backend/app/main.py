...
from app.api.endpoints import admin, auth, health, preferences, products, users
...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost:5173",
        "http://localhost:3000",
        "http://10.0.0.1:5173",  # VPN access
        "https://pricewatch.it.com",
        "https://www.pricewatch.it.com",
    ],
